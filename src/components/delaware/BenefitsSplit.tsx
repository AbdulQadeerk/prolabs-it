...
export default function BenefitsSplitDelaware() {
    ...
    >
      <div className="container">
        ...
        <div className={s["about-text"]}>
          <p>
            Professional Labs simplifies complex IT environments by delivering secure, scalable, and cost-efficient solutions for Delaware organizations and global clients.
          </p>
          <p>
            Founded in 1997 and headquartered in Dubai, we specialize in cybersecurity, managed IT services, cloud infrastructure, and Microsoft ecosystem solutions.
          </p>
        </div>
        ...
        <div className={s["benefits-grid"]}>
          <div className={s["benefit-card"]}>
            ...
            <p>
              Our platform enables automation, proactive monitoring, and advanced analytics to help Delaware businesses reduce downtime and improve security posture.
            </p>
          ...
          <div className={s["benefit-card"]}>
            ...
            <p>
              We combine automation, monitoring, and threat intelligence to protect systems at every level.
            </p>
            <div className={s["card-stats"]}>
              <div className={s["cs-item"]}>
