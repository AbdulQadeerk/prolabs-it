...
export default function HeroDelaware() {
      ...
      <div className={`container ${s["hero-container"]}`}>
        <div className={s["hero-content"]}>
          ...
          <h1 className={s["hero-title"]}>
            Managed IT Services &amp; Cybersecurity Solutions in Delaware
          </h1>
          <p className={s["hero-subtitle"]}>
            Supporting Delaware Businesses with Secure IT Infrastructure & Cloud Management
          </p>
