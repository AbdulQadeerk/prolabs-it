...
export default function LeadershipBandDelaware() {
        ...
        <div className={s["leadership-card"]}>
          <div className={s["leadership-content"]}>
            ...
            <h2 className={s["leadership-heading"]}>
              ...
              trusted across 35+ countries since 1997.
            </h2>
            <p className={s["leadership-desc"]}>
              We help organizations accelerate digital transformation through cybersecurity, cloud, and managed IT services.
            </p>
