      ...
      <div className="container">
        ...
        <div className="platform-showcase">
          <div className="showcase-content">
            ...
            <p>
              Monitor, manage, and secure all your endpoints (Windows, Mac, Linux, SNMP) from a single pane of glass.
              Reduce complexity and improve efficiency with powerful automation.
            </p>
