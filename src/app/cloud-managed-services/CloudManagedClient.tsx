...
export default function CloudManagedClient() {
      ...
      <section className="sv-hero-band">
        <div className="container">
          <nav className="sv-breadcrumb">
            ...
            <span>Services</span>
            <span className="sep">/</span>
            <span className="active">Cloud Managed Services</span>
          </nav>
          <h1 className="sv-hero-h1">Cloud Managed Services Provider</h1>
        </div>
      </section>
          ...
          <div className="sv-hero-grid">
            ...
            >
              <motion.h2 variants={fadeInUp} className="sv-display-h2">
                Streamline Cloud Operations with Our Managed Cloud Services
              </motion.h2>
