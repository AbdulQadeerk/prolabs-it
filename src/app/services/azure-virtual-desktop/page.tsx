    ...
    return (
        <main className="sv-page sv-azure">
                ...
                <div className="container">
                    <div className="sv-hero-grid">
                        ...
                        >
                            ...
                            <motion.p variants={fadeInUp} className="sv-body-text" style={{ fontSize: "1.2rem", marginBottom: "40px" }}>
                                Experience the seamless performance of Windows 10 and 11 on any device, fully managed in the cloud.
                            </motion.p>
            ...
            <section className="sv-section-info">
                <div className="container">
                    <div className="sv-info-grid">
                        ...
                        >
                            <h2 className="sv-h2" style={{ marginBottom: "24px" }}>Azure Virtual Desktop can reduce costs</h2>
                            <p className="sv-p" style={{ marginBottom: "24px", color: "var(--sv-gray)" }}>
                                If you already have a valid Microsoft 365 or Windows per-user license, Azure Virtual Desktop
                                can be utilized by your organization at no additional cost. Using a managed service in the cloud
                                for your whole VDI setup is a great way to save time and energy on management.
                            </p>
                            <div className="sv-pros-grid" style={{ gridTemplateColumns: "1fr", gap: "15px" }}>
                                {costBenefits.map((point, idx) => (
                                    <div key={idx} className="sv-pro-item" style={{ background: "transparent", padding: 0, border: "none" }}>
                                        <div className="sv-check-icon-wrap" style={{ marginTop: "4px" }}>
                                            <CheckCircle2 size={18} color="var(--sv-accent)" />
                                        </div>
                                        <span style={{ fontSize: "0.95rem", color: "var(--sv-ink)", fontWeight: 600 }}>{point}</span>
                                    </div>
                                ))}
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="sv-p" style={{ color: "rgba(255,255,255,0.7)", marginBottom: "30px" }}>
                                The Azure Virtual Desktop client is available for all major platforms, allowing you
                                to access your desktop and apps from any internet-connected device.
                            </p>
                            <div className="sv-pills-row" style={{ justifyContent: "flex-start", gap: "10px" }}>
                                {deviceSupport.map((device, idx) => (
                                    <span key={idx} className="sv-pill" style={{ background: "rgba(255,255,255,0.1)", color: "#fff", border: "1px solid rgba(255,255,255,0.2)" }}>
                                        {device.icon} {device.name}
                                    </span>
                                ))}
                            </div>
                            <div style={{ marginTop: "40px" }}>
                                <h4 className="sv-h4" style={{ color: "#fff", marginBottom: "15px" }}>Optimize Operations</h4>
                                <p className="sv-p" style={{ fontSize: "0.95rem", color: "rgba(255,255,255,0.6)" }}>
                                    Pick the right Azure VM for optimal performance and make use of Windows 10/11
                                    multi-session advantage to support numerous users in a single instance.
                                </p>
                            </div>
                        </motion.div>
                    </div>
            ...
            <section className="sv-section-focus" style={{ background: "#fff" }}>
                <div className="container">
                    ...
                    >
                        ...
                        <div>
                            <h3 className="sv-h2" style={{ marginBottom: "20px" }}>Get the most out of Microsoft Teams and Office</h3>
                            <p className="sv-p" style={{ color: "var(--sv-gray)" }}>
                                If your company uses Microsoft products like Outlook, OneDrive, and Teams, we ensure
                                your employees can perform tasks as efficiently on the virtual desktop as they would on
                                a physical device. We specialize in optimizing these workflows for high latency or low bandwidth environments.
                            </p>
                        </div>
                    </motion.div>
                </div>
            ...
            <section className="sv-section-info" style={{ background: "var(--sv-bg)" }}>
                <div className="container">
                    <div style={{ textAlign: "center", marginBottom: "60px" }}>
                        <h2 className="sv-h2" style={{ marginBottom: "16px" }}>Key Capabilities</h2>
                        <p className="sv-subtitle">Setting up an Azure Virtual Desktop environment is easy and flexible</p>
                    </div>
                    <div className="sv-grid-layout" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))" }}>
                        {keyCapabilities.map((cap, idx) => (
                            ...
                            >
                                <div className="sv-grid-icon" style={{ margin: "0 0 24px 0" }}>{cap.icon}</div>
                                <h5 style={{ fontSize: "1.2rem", fontWeight: 800, marginBottom: "12px" }}>{cap.title}</h5>
                                <p style={{ fontSize: "0.95rem", color: "var(--sv-gray)" }}>{cap.desc}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
                ...
                <div className="container">
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "60px", alignItems: "center" }}>
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                            <h2 className="sv-h2" style={{ marginBottom: "24px" }}>Deploy Azure Virtual Desktop with AMMP</h2>
                            <p className="sv-p" style={{ color: "var(--sv-gray)", marginBottom: "20px" }}>
                                The Azure Migration and Modernization Program (AMMP) offers evaluation, proof-of-concept,
                                milestone rewards, Azure credits, and technical training for all three control planes.
                            </p>
                            <p className="sv-p" style={{ color: "var(--sv-gray)" }}>
                                If a partner meets requirements for Advanced Specialization or for Citrix/VMware partners,
                                they can enable whichever control planes they like in AMMP for a seamless transition.
                            </p>
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, x: 30 }}
            ...
            <section className="sv-section-analysis">
                <div className="container">
                    <div style={{ textAlign: "center", marginBottom: "60px" }}>
                        <h2 className="sv-h2" style={{ color: "white", marginBottom: "16px" }}>What makes Azure Virtual Desktop so trusted?</h2>
                        <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "1.2rem" }}>Integral safety features and compliance by design</p>
                    </div>
                    ...
                    <div className="sv-tech-grid" style={{ marginBottom: "80px" }}>
                        {securityFeatures.map((feat, idx) => (
                            ...
                            >
                                <div className="sv-tech-icon" style={{ background: "rgba(34, 167, 224, 0.1)", color: "var(--sv-accent)" }}>{feat.icon}</div>
                                <div>
                                    <h4 className="sv-h4" style={{ color: "#fff", marginBottom: "10px" }}>{feat.title}</h4>
                                    <p style={{ fontSize: "0.9rem", color: "rgba(255,255,255,0.6)" }}>{feat.desc}</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="sv-focus-box"
                        style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.05)", padding: "40px", color: "#fff" }}
                    >
                        <div style={{ textAlign: "center", width: "100%" }}>
                            <ShieldCheck size={48} color="var(--sv-accent)" style={{ margin: "0 auto 20px" }} />
                            <h3 className="sv-h3" style={{ color: "#fff" }}>Global Compliance Standards</h3>
                            <p style={{ color: "rgba(255,255,255,0.7)", maxWidth: "800px", margin: "0 auto" }}>
                                Take advantage of many certifications Azure Virtual Desktop has earned, including
                                <strong> ISO 27001, 27018, 27701, PCI, FedRAMP High, HIPAA, and more</strong>.
                                Secure your business data by keeping it in the cloud rather than on local PCs.
                            </p>
                        </div>
                    </motion.div>
                </div>
            ...
            <section className="sv-section-faq">
                <div className="container">
                    <h2 className="sv-h2" style={{ textAlign: "center", marginBottom: "60px" }}>FAQ's</h2>
                ...
                <div className="container">
                    ...
                    >
                        ...
                        <p style={{ color: "rgba(255,255,255,0.8)", fontSize: "1.15rem", marginBottom: "40px", maxWidth: "600px", margin: "0 auto 40px" }}>
                            Get Azure Virtual Desktop Pricing and a free 30-minute consultation with our experts.
                        </p>
                        <div style={{ display: "flex", justifyContent: "center", gap: "20px", flexWrap: "wrap" }}>
                            <Link href="/contact" className="sv-btn-white">
                                Get Pricing Now <ArrowRight size={18} />
                            </Link>
                            <Link href="/contact" className="sv-btn-primary" style={{ background: "transparent", border: "2px solid white", boxShadow: "none" }}>
