      ...
      <section className="sv-hero-band">
        <div className="container">
          <nav className="sv-breadcrumb">
            ...
            <span>Services</span>
            <span className="sep">/</span>
            <span className="active">Managed Security & Cloud IT Support - Doha, Qatar</span>
          </nav>
          <h1 className="sv-hero-h1">Managed Security & Cloud IT Support - Doha, Qatar</h1>
        </div>
      </section>
      ...
      <section className="sv-hero-main">
        <div className="container">
          <div className="sv-hero-grid">
            ...
            >
              <motion.h2 variants={fadeInUp} className="sv-display-h2">Managed Security & Cloud IT Support - Doha, Qatar</motion.h2>
